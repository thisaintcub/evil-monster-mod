...
class DialogueBox extends FlxSpriteGroup
{
	...
	{
		var dialoguePath = Paths.file('res/images/dialogue/portraits/$curCharacter/$file');
			...
			if (newChar != null)
			{
				...
				if (portraitData.sounds != null)
				{
					if (portraitData.soundPath != null)
						alphabetText.beginPath = "res/" + portraitData.soundPath;
					else
						alphabetText.beginPath = 'res/images/dialogue/portraits/$curCharacter/';
