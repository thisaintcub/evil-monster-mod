...
class FlxSoundTray extends Sprite
{
	...
	public var volumeUpSound:FlxSoundAsset = "res/sounds/volUp";

	/**The sound used when decreasing the volume.**/
	public var volumeDownSound:FlxSoundAsset = 'res/sounds/volDown';
	...
	public function new()
	{
		...
		var dtf:TextFormat = new TextFormat(FlxAssets.FONT_DEFAULT, 10, 0xb20000);
		...
		for (i in 0...10)
		{
			tmp = new Bitmap(new BitmapData(4, i + 1, false, 0xb20000));
			addChild(tmp);
			_bars.push(tmp);
		}
		updateSize();
	 ...
	 */
	public function showAnim(volume:Float, ?sound:FlxSoundAsset, duration = 1.0, label = "I HEAR")
	{
		if (sound != null)
